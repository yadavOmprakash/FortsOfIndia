...
const ResearchPaper = () => {
  ...
  useEffect(() => {
    let api = `https://indianculture.nvli.in/rest/research-papers?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_dc_type=${dcTypevalue}`;
        ...
        <Container style={{ marginTop: "20px" }}>
          ...
          <Offcanvas show={show} onHide={handleClose} backdrop="static" className="sidepanel">
            <Offcanvas.Header closeButton>
              <Offcanvas.Title style={{ textAlign: "center" }}>Research Paper Filter</Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body>
