...
//   useEffect(() => {
//     let api = `https://indianculture.nvli.in/rest/reports-and-proceedings?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_dc_type=${dcTypevalue}`;
//     console.log(api);
...
//               <Offcanvas.Title style={{ textAlign: "center" }}>Reports & Proceedings Filter</Offcanvas.Title>
//             </Offcanvas.Header>
//             <Offcanvas.Body>
...
//   );
// };
// export default ReportsandProceedings;
...
const ReportsandProceedings = () => {
  ...
  let api = `https://indianculture.nvli.in/rest/reports-and-proceedings?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_dc_type=${dcTypevalue}&field_parent_library_name=${fieldparentlibraryname}`;
  ...
  const handleFieldParentLibraryName = (value) => {
    if (fieldparentlibraryname === value) {
      setFieldParentLibraryName(""); // Uncheck the checkbox if it's already checked.
    } else {
      setFieldParentLibraryName(value); // Check the checkbox by setting the value.
    }
  };
  
  const handleDctypevalue = (value) => {
    if (dcTypevalue === value) {
      setDctypevalue(""); // Uncheck the checkbox if it's already checked.
    } else {
      setDctypevalue(value); // Check the checkbox by setting the value.
    }
  };
    ...
    <div className="App">
      ...
      <Container>
        <div className="row">
          ...
          {/* Conditionally render CardDetails or Card based on detailData */}
