...
const Rarebooks = () => {
  ...
  useEffect(() => {
    let api = `https://indianculture.nvli.in/rest/rarebooks?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_parent_library_name=${dcTypevalue}`;
    console.log(api);
        ...
        <Container style={{ marginTop: "20px" }}>
          ...
          <Offcanvas show={show} onHide={handleClose} backdrop="static" className="sidepanel">
            <Offcanvas.Header closeButton>
              <Offcanvas.Title style={{ textAlign: "center" }}>Rare Books Filter</Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body>
