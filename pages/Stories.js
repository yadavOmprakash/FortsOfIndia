...
import Cardstories from "../components/Card/Cardstories";
...
const Stories = () => {
  ...
  let api = `https://indianculture.nvli.in/rest/stories?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_dc_type=${dcTypevalue}`;
  ...
  return (
    <div className="App">
          ...
          <Row>
           ...
           <Offcanvas show={show} onHide={handleClose} backdrop="static" className="sidepanel">
            <Offcanvas.Header closeButton>
              <Offcanvas.Title style={{ textAlign: "center" }}>Stories Filter</Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body>
      ...
      {detailData !== null ? (
        ...
        <Container>
          <div className="row">
            <Cardstories page="/" search_results={search_results} setDetailData={setDetailData} />
          </div>
        </Container>
      )}
