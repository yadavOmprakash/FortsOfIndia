...
const PhotoArchives = () => {
  ...
  useEffect(() => {
    let api = `https://indianculture.nvli.in/rest/photo-archive?search_api_fulltext=${searchQuery}&page=${pageNumber}&field_parent_library_name=${dcTypevalue}`;
    console.log(api);
